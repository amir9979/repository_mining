...
class CreateLoggers:
    ...
    def _create_handlers(self):
        ...
        self.summary_file = logging.FileHandler(os.path.join(paper_dir, "(11)_summary.log"), "a")
        self.success_file = logging.FileHandler(os.path.join(paper_dir, "(11)_success.log"), "a")
        self.failure_file = logging.FileHandler(os.path.join(paper_dir, "(11)_failure.log"), "a")
        self.failure_verbose_file = logging.FileHandler(os.path.join(paper_dir, "(11)_failure_verbose.log"), "a")
